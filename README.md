...
Right now I'm working on **MockyFast**, a Python CLI tool to define and serve mock APIs from YAML and JSON files.
...
## Currently building
- **MockyFast** — a CLI tool for mocking HTTP APIs locally
